...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./TeKo.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("BK", "w")  
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/TeKo-TEAM/Files_TeKo/main/File_Bot/commands.lua") 
...
local text1 = database:get(bot_id..'TeKo:new:sourse1') or '━━━━━━━━━━━━'
...
TeKo_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
TeKo_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
TeKo_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
TeKo_Msg = 'امبروطور التفاعل' 
...
-------------------------------------------------------------------------------------------------------------
function SourceTeKo(msg,data) -- بداية العمل
if msg then
...
send(msg.chat_id_, msg.id_,TeKo_Msg) 
return false  
end 
if text then    
...
send(msg.chat_id_, msg.id_,'❃∫  عدد الكروبات الان » { '..#group..' }'..TeKok..''..TeKo..'\n❃∫  الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
usertext = '\n ❃∫ العضو » ['..result.title_..'](t.me/'..(username or 'TeKo_MOD')..')'
status  = '\n ❃∫ تم ترقيته مطور'
...
usertext = '\n ❃∫ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'TeKo_MOD')..')'
status  = '\n ❃∫ تم ترقيته مطور'
...
local TeKo1_Msg = database:get(bot_id.."TeKo1:Add:Filter:Rp2"..text..msg.chat_id_)   
if TeKo1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ❃∫ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'TeKo_MOD')..') \n ❃∫ '..TeKo1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if TeKo_Msg and not Special(msg) then  
local TeKo_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if TeKo_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ❃∫ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ❃∫ ["..TeKo_Msg.."] \n")
else
send(msg.chat_id_,0," ❃∫ العضو : {["..data.first_name_.."](T.ME/TeKo_MOD)}\n ❃∫ ["..TeKo_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ❃∫ عذرا » {["..data.first_name_.."](T.ME/TeKo_MOD)}\n ❃∫ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
━━━━━━━━━━━━
 ❃∫ ↬𝐁𝐎𝐘𝐊𝐀 𝐓𝐄𝐀𝐌
━━━━━━━━━━━━
 ❃∫ ↬[Channel TeKo](t.me/TeKo_MOD) 
━━━━━━━━━━━━
 ❃∫ ↬[Information](t.me/NiGGa_SoUrcE)
━━━━━━━━━━━━
 ❃∫ ↬[DEVELOPER](t.me/IIIIIX)
━━━━━━━━━━━━
 ❃∫ ↬[The way his inauguration](https://t.me/TeKo_MOD/8)
━━━━━━━━━━━━
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ❃∫ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'TeKo_MOD')..') \n ❃∫ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ❃∫ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'TeKo_MOD')..') \n ❃∫ تـم قفـل التاك بالكتم ')
end,nil)   
...
if SudoBot(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/TeKo-TEAM/Files_TeKo/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ❃∫ اهلا بك في متجر ملفات بويكا\n ❃∫ ملفات السورس ↓\n━━━━━━━━━━━━\n\n"
local TextE = "\n━━━━━━━━━━━━\n ❃∫ علامة تعني { ✓ } ملف مفعل\n ❃∫ علامة تعني { ✘ } ملف معطل\n ❃∫ قناة سورس بويكا ↓\n".." ❃∫ [اضغط هنا لدخول](t.me/TeKo_MOD) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/TeKo-TEAM/Files_TeKo/main/File_Bot/"..file)
if res == 200 then
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ❃∫ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'TeKo_MOD')..')'
status  = '\n ❃∫ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ❃∫ العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ❃∫ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'TeKo_MOD')..')'
...
database:set(bot_id.."TeKo1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."TeKo1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," ❃∫ ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."TeKo1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."TeKo1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."TeKo1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."TeKo1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," ❃∫ تم منع الكلمه مع التحذير")  
database:del(bot_id.."TeKo1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."TeKo1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."TeKo1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."TeKo1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," ❃∫ ارسل الكلمه الان")  
database:set(bot_id.."TeKo1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."TeKo1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."TeKo1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."TeKo1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."TeKo1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."TeKo1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."TeKo1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."TeKo1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."TeKo1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n ❃∫ قائمة المنع \n━━━━━━━━━━━━\n"
for k,v in pairs(list) do  
local TeKo_Msg = database:get(bot_id.."TeKo1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..TeKo_Msg.."}\n"    
end  
if #list == 0 then  
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ❃∫ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'TeKo_MOD')..')'..'\n ❃∫ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if not database:get(bot_id..'TeKo:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_) then           
...
database:setex(bot_id..'TeKo:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
end
end
...
database:sadd(bot_id.."TeKo:allM"..msg.chat_id_, msg.id_)
end
if text == ("امسح") and cleaner(msg) then  
local list = database:smembers(bot_id.."TeKo:allM"..msg.chat_id_)
for k,v in pairs(list) do
local Message = v
if Message then
t = "❃∫ تم مسح "..k.." من الوسائط الموجوده"
DeleteMessage(msg.chat_id_,{[0]=Message})
database:del(bot_id.."TeKo:allM"..msg.chat_id_)
end
end
if #list == 0 then
...
local num = database:smembers(bot_id.."TeKo:allM"..msg.chat_id_)
...
send(msg.chat_id_, msg.id_,'['..TeKo_Msg[math.random(#TeKo_Msg)]..']') 
return false
end
...
if database:get(bot_id.."TeKo:all:Time"..msg.chat_id_..':'..msg.sender_user_id_) then  
return 
send(msg.chat_id_, msg.id_,"انتظر دقيقه من فضلك")
end
database:setex(bot_id..'TeKo:all:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
tdcli_function({ID="GetChannelFull",channel_id_ = msg.chat_id_:gsub('-100','')},function(argg,dataa) 
tdcli_function({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub('-100',''), offset_ = 0,limit_ = dataa.member_count_},function(ta,TeKo)
x = 0
tags = 0
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'TeKo_MOD')..')'
local iduser = result.sender_user_id_
...
local TeKo = ' ❃∫ عدد الادمنيه : '..data.administrator_count_..
'\n\n ❃∫ عدد المطرودين : '..data.kicked_count_..
'\n\n ❃∫ عدد الاعضاء : '..data.member_count_..
'\n\n ❃∫ عدد رسائل الكروب : '..(msg.id_/2097152/0.5)..
'\n\n ❃∫  اسم الكروب : ['..ta.title_..']'
send(msg.chat_id_, msg.id_, TeKo) 
end,nil)
end,nil)
end 
...
if not database:sismember(bot_id..'Spam:Texting'..msg.sender_user_id_,text) then
database:sadd(bot_id..'Spam:Texting'..msg.sender_user_id_,text) 
tdcli_function ({ID = "GetChatMember",chat_id_ = msg.chat_id_,user_id_ = msg.sender_user_id_},function(arg,da)  tdcli_function ({ ID = "SendChatAction",  chat_id_ = msg.sender_user_id_, action_ = {  ID = "SendMessageTypingAction", progress_ = 100}  },function(arg,ta)  tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)  tdcli_function ({ID = "GetUserProfilePhotos",user_id_ = msg.sender_user_id_,offset_ = 0,limit_ = 1},function(extra,TeKo,success) 
if da.status_.ID == "ChatMemberStatusCreator" then 
rtpa = 'المالك'
elseif da.status_.ID == "ChatMemberStatusEditor" then 
rtpa = 'مشرف' 
...
local photps = (TeKo.total_count_ or 0)
...
local rdphoto = TeKoa[math.random(#TeKoa)]
if not database:get(bot_id..'Bot:Id:Photo'..msg.chat_id_) then      
...
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, TeKo.photos_[0].sizes_[1].photo_.persistent_id_,get_id_text)       
else 
...
-- vardump(data) 
TeKodx(msg.chat_id_, msg.id_, ' ❃∫ ايدي المجموعة » ( '..msg.chat_id_..' )\n ❃∫ عدد الادمنيه » ( *'..data.administrator_count_..' )*\n ❃∫ عدد المحظورين » ( *'..data.kicked_count_..' )*\n ❃∫ عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
TeKo = text:match("^اضف رسائل (%d+)$")
database:set(bot_id..'id:user'..msg.chat_id_,TeKo)  
...
TeKo = text:match("^اضف نقاط (%d+)$")
database:set(bot_id..'idgem:user'..msg.chat_id_,TeKo)  
...
database:set(bot_id.." TeKo:zhrf_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل الزخرفه" and Manager(msg) then
send(msg.chat_id_, msg.id_,'❃∫ تم تفعيل الزخرفه')
database:set(bot_id.." TeKo:zhrf_Bots"..msg.chat_id_,"open")
end
if text and text:match("^زخرفه (.*)$") and database:get(bot_id.." TeKo:zhrf_Bots"..msg.chat_id_) == "open" then
...
database:set(bot_id.." TeKo:brj_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل الابراج" and Manager(msg) then
send(msg.chat_id_, msg.id_,'❃∫ تم تفعيل الابراج')
database:set(bot_id.." TeKo:brj_Bots"..msg.chat_id_,"open")
end
if text and text:match("^برج (.*)$") and database:get(bot_id.." TeKo:brj_Bots"..msg.chat_id_) == "open" then
...
database:set(bot_id.." TeKo:age_Bots"..msg.chat_id_,"close")
end
if text == "تعطيل حساب العمر" and Manager(msg) then
send(msg.chat_id_, msg.id_, '❃∫ تم تعطيل حساب العمر')
database:set(bot_id.." TeKo:age_Bots"..msg.chat_id_,"close")
...
database:set(bot_id.." TeKo:age_Bots"..msg.chat_id_,"open")
end
if text and text:match("^احسب (.*)$") and database:get(bot_id.." TeKo:age_Bots"..msg.chat_id_) == "open" then
...
database:set(bot_id.."TeKo:movie_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الافلام" and Mod(msg) then
send(msg.chat_id_, msg.id_,'❃∫ تم تفعيل الافلام')
database:set(bot_id.."TeKo:movie_bot"..msg.chat_id_,"open")
end
if text and text:match("^فلم (.*)$") and database:get(bot_id.."TeKo:movie_bot"..msg.chat_id_) == "open" then
...
TeKo = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(TeKo)
...
------------------------------------------------------------------------
local TeKoAbot = database:get(bot_id.."TeKo1:Add:Filter:Rp2"..text..result.chat_id_)   
if TeKoAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ❃∫ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ❃∫ ["..TeKoAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local TeKo1_Msg = database:get(bot_id.."TeKo1:Add:Filter:Rp2"..text..result.chat_id_)   
if TeKo1_Msg then    
send(msg.chat_id_, msg.id_," ❃∫ "..TeKo1_Msg)
