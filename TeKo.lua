...
io.popen("mkdir TeKo_Files")
t = "\27[35m".."\nAll Files Started : \n____________________\n"..'\27[m'
i = 0
for v in io.popen('ls TeKo_Files'):lines() do
if v:match(".lua$") then
i = i + 1
...
if hash or Bot(msg) or DevTeKo(msg) or TeKoDevSou(msg) then    
return true  
else  
return false  
end  
...
if hash or DevTeKo(msg) or DevBot(msg) or TeKoDevSou(msg) then     
return true 
else 
return false 
end 
...
if hash or DevTeKo(msg) or DevBot(msg) or TeKoDevSou(msg) or creatorA(msg) then     
return true 
else 
return false 
end 
...
if hash or DevTeKo(msg) or DevBot(msg) or BasicConstructor(msg) or TeKoDevSou(msg) or creatorA(msg) then             
return true    
else    
return false    
end 
...
if hash or DevTeKo(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or TeKoDevSou(msg) or creatorA(msg) then             
return true    
else    
return false    
end 
...
if hash or DevTeKo(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) or TeKoDevSou(msg) or creatorA(msg) then             
return true    
else    
return false    
end 
...
if hash or Bot(msg) or  DevTeKo(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) or Addictive(msg) or TeKoDevSou(msg) or creatorA(msg) then             
return true 
else 
return false 
end 
...
if DevTeKoe(user_id) == true then
var = true
elseif DevTeKo(user_id) == true then
var = true
elseif TeKoDevSou(user_id) == true then
var = true
...
if tonumber(user_id) == tonumber(1423337662) then  
var = 'مطور السورس'
elseif DevTeKoe(user_id) == true then
var = "المطور الاساسي"  
elseif tonumber(user_id) == tonumber(bot_id) then  
var = "البوت"
...
local url,res = https.request('https://mode-pro.tk/xTeKox/Johoin.php?id='..msg.sender_user_id_)
...
local UserName = (data.username_ or "TeKo_SoUrcE")
...
function TeKo_Files(msg)
for v in io.popen('ls TeKo_Files'):lines() do
if v:match(".lua$") then
plugin = dofile("TeKo_Files/"..v)
if plugin.TeKo and msg then
pre_msg = plugin.TeKo(msg)
end
end
end
send(msg.chat_id_, msg.id_,pre_msg)  
end
function TeKo_Started_Bot(msg,data) -- بداية العمل
if msg then
...
local TeKo_Msg = database:sismember(bot_id.."List:Filter:text"..msg.chat_id_,text) 
if TeKo_Msg then    
...
function Function_TeKo(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_TeKo, nil)
return false
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_TeKo, nil)
return false
end
...
if text == ("رفع مطور ثانوي") and tonumber(msg.reply_to_message_id_) ~= 0 and TeKoDevSou(msg) then
function Function_TeKo(extra, result, success)
...
if text and text:match("^رفع مطور ثانوي @(.*)$") and TeKoDevSou(msg) then
...
if text and text:match("^رفع مطور ثانوي (%d+)$") and TeKoDevSou(msg) then
...
if text == ("حذف مطور ثانوي") and tonumber(msg.reply_to_message_id_) ~= 0 and TeKoDevSou(msg) then
function Function_TeKo(extra, result, success)
...
if text and text:match("^حذف مطور ثانوي @(.*)$") and TeKoDevSou(msg) then
...
if text and text:match("^حذف مطور ثانوي (%d+)$") and TeKoDevSou(msg) then
...
if text == ("الثانويين") and DevTeKo(msg) then
...
if text == ("مسح الثانويين") and TeKoDevSou(msg) then
database:del(bot_id.."DEV:Sudo:T")
send(msg.chat_id_, msg.id_, "\n•  تم مسح قائمة المطورين الثانويين  ")
end
if text == ("مسح قائمه العام") and DevTeKo(msg) then
database:del(bot_id.."GBan:User")
send(msg.chat_id_, msg.id_, "\n• تم مسح قائمه العام")
return false
end
if text == ("مسح المطورين") and DevTeKo(msg) then
...
if text == ("قائمه العام") and DevTeKo(msg) then
...
if text == ("المطورين") and DevTeKo(msg) then
...
if text == ("حظر عام") and tonumber(msg.reply_to_message_id_) ~= 0 and DevTeKo(msg) then
function Function_TeKo(extra, result, success)
...
if text and text:match("^حظر عام @(.*)$")  and DevTeKo(msg) then
...
if text and text:match("^حظر عام (%d+)$") and DevTeKo(msg) then
...
if text == ("الغاء العام") and tonumber(msg.reply_to_message_id_) ~= 0 and DevTeKo(msg) then
function Function_TeKo(extra, result, success)
...
if text and text:match("^الغاء العام @(.*)$") and DevTeKo(msg) then
...
if text and text:match("^الغاء العام (%d+)$") and DevTeKo(msg) then
...
if text == ("رفع مطور") and tonumber(msg.reply_to_message_id_) ~= 0 and DevTeKo(msg) then
function Function_TeKo(extra, result, success)
...
if text and text:match("^رفع مطور @(.*)$") and DevTeKo(msg) then
...
if text and text:match("^رفع مطور (%d+)$") and DevTeKo(msg) then
local userid = text:match("^رفع مطور (%d+)$")
database:sadd(bot_id.."Sudo:User", userid)
Reply_Status(msg,userid,"reply","• تم ترقيته مطور في البوت")  
return false 
end
if text == ("حذف مطور") and tonumber(msg.reply_to_message_id_) ~= 0 and DevTeKo(msg) then
function Function_TeKo(extra, result, success)
...
if text and text:match("^حذف مطور @(.*)$") and DevTeKo(msg) then
...
if text and text:match("^حذف مطور (%d+)$") and DevTeKo(msg) then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
local TeKort = database:get(bot_id.."Comd:New:rt:bot:"..RTPA..msg.chat_id_)
if TeKort == "مميز" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"• العضو > ["..data.first_name_.."](t.me/"..(data.username_ or "TeKo_SoUrcE")..")".."\n• تم رفعه "..RTPA.." هنا\n")
database:set(bot_id.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,RTPA) 
database:sadd(bot_id.."Special:User"..msg.chat_id_,result.sender_user_id_)  
elseif TeKort == "ادمن" and Owner(msg) then 
send(msg.chat_id_, msg.id_,"• العضو > ["..data.first_name_.."](t.me/"..(data.username_ or "TeKo_SoUrcE")..")".."\n• تم رفعه "..RTPA.." هنا\n")
database:set(bot_id.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,RTPA)
database:sadd(bot_id.."Mod:User"..msg.chat_id_,result.sender_user_id_)  
elseif TeKort == "مدير" and Constructor(msg) then
send(msg.chat_id_, msg.id_,"• العضو > ["..data.first_name_.."](t.me/"..(data.username_ or "TeKo_SoUrcE")..")".."\n• تم رفعه "..RTPA.." هنا\n")
database:set(bot_id.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,RTPA)  
database:sadd(bot_id.."Manager"..msg.chat_id_,result.sender_user_id_)  
elseif TeKort == "عضو" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"• العضو > ["..data.first_name_.."](t.me/"..(data.username_ or "TeKo_SoUrcE")..")".."\n• تم رفعه "..RTPA.." هنا\n")
end
end,nil)   
end   
...
if result.id_ then
local TeKort = database:get(bot_id.."Comd:New:rt:bot:"..text1[2]..msg.chat_id_)
if TeKort == "مميز" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"• العضو > ["..result.title_.."](t.me/"..(text1[3] or "TeKo_SoUrcE")..")".."\n• تم رفعه "..text1[2].." هنا")   
database:sadd(bot_id.."Special:User"..msg.chat_id_,result.id_)  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n•> العضو > ['..data.first_name_..'](t.me/'..(data.username_ or 'TeKo_SoUrcE')..') ~'
...
usertext = '\n• العضو > ['..result.title_..'](t.me/'..(username or 'TeKo_SoUrcE')..')'
status  = '\n• تم تقيده لمدة  { '..TextEnd[2]..' '..TextEnd[3]..'}'
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n•  العضو > ['..data.first_name_..'](t.me/'..(data.username_ or 'TeKo')..') '
...
*•●○●○●○●•ٴ*
𝘊𝘩 - [𝘯𝘪𝘨𝘨𝘢](http://t.me/TeKo_SoUrcE)•
]]
send(msg.chat_id_, msg.id_,Text)
...
if text == ("مسح ردود المطور") and DevTeKo(msg) then 
...
if text == ("ردود المطور") and DevTeKo(msg) then 
local list = database:smembers(bot_id.."List:Rd:Sudo")
text = "\n• قائمة ردود المطور \n ●○━━━━𝘕𝘎━━━━○●\n"
for k,v in pairs(list) do
...
if text == "اضف رد للكل" and DevTeKo(msg) then 
send(msg.chat_id_, msg.id_,"•  ارسل الكلمه التري تريد اضافتها")
database:set(bot_id.."Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
return false 
end
if text == "حذف رد للكل" and DevTeKo(msg) then 
...
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'TeKo_SoUrcE')..')'
...
local UserName = (b.username_ or "TeKo_SoUrcE")
...
if database:get(bot_id.."Status:Bc") and not DevTeKo(msg) then 
...
لعبة رياضيات >> رياضيات
 ...
 لعبة بات >> بات
•━━━━━━• 
- Ch [𝘕𝘐𝘎𝘎𝘈 - SoUrCe](https://t.me/TeKo_SoUrcE)
]]
...
if text == "تنظيف المشتركين" and DevTeKo(msg) then
...
if text == "تنظيف الكروبات" and DevTeKo(msg) then
...
if text == ("تحديث السورس") and DevTeKo(msg) then  
send(msg.chat_id_,msg.id_,'• تم التحديث')
os.execute('rm -rf TeKo.lua')
os.execute('rm -rf start.lua')
os.execute('wget https://raw.githubusercontent.com/TeKoBot/TeKo/main/TeKo.lua')
os.execute('wget https://raw.githubusercontent.com/TeKoBot/TeKo/main/start.lua')
dofile('TeKo.lua')  
return false
end
if text == "راسلني" then
...
ge = https.request('https://mode-pro.tk/ageApi/TeKoapi.php?age='..URL.escape(Textage)..'')
ag = JSON.decode(ge)
send(msg.chat_id_, msg.id_, ag.ok.Rt)
end
if text == 'السيرفر' and DevTeKo(msg) then 
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '•  𝘕𝘐𝘎𝘎𝘈  .',url="t.me/TeKo_SoUrcE"}},
}
local msg_id = msg.id_/2097152/0.5
...
if text and text:match("^تعين عدد الاعضاء (%d+)$") and DevTeKo(msg) then
...
if text == 'جلب نسخه احتياطيه' and DevTeKo(msg) then
local list = database:smembers(bot_id..'Chek:Groups')  
local memo = database:smembers(bot_id..'UsersBot')  
local t = '{"BOT_ID": '..bot_id..',"GP_BOT":{'  
for k,v in pairs(list) do   
...
if text == 'الملفات' and DevTeKo(msg) then
t = '• جميع الملفات : \n ●○━━━━𝘕𝘎━━━━○● \n'
i = 0
for v in io.popen('ls TeKo_Files'):lines() do
if v:match(".lua$") then
...
if DevTeKo(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/TEKOBOT/files_TeKo/main/getfile.json")
if res == 200 then
...
local Check_File_is_Found = io.open("TeKo_Files/"..name,"r")
...
if text and text:match("^(تعطيل ملف) (.*)(.lua)$") and DevTeKo(msg) then
local name_t = {string.match(text, "^(تعطيل ملف) (.*)(.lua)$")}
local file = name_t[2]..'.lua'
local file_bot = io.open("TeKo_Files/"..file,"r")
if file_bot then
io.close(file_bot)
...
local json_file, res = https.request("https://raw.githubusercontent.com/TEKOBOT/files_TeKo/main/files_TeKo/"..file)
if res == 200 then
os.execute("rm -fr TeKo_Files/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('TeKo.lua')  
else
...
if text and text:match("^(تفعيل ملف) (.*)(.lua)$") and DevTeKo(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/TEKOBOT/files_TeKo/main/files_TeKo/"..file)
if res == 200 then
local chek = io.open("TeKo_Files/"..file,'w+')
...
if text == "مسح جميع الملفات" and DevTeKo(msg) then
os.execute("rm -fr TeKo_Files/*")
send(msg.chat_id_,msg.id_,"• تم حذف جميع الملفات")
return false
end
if text == 'نقل الاحصائيات' and DevTeKo(msg) then
...
if text == 'حذف كليشه المطور' and DevTeKo(msg) then
database:del(bot_id..'Text_Dev')
send(msg.chat_id_, msg.id_,'•  تم حذف كليشه المطور')
end
if text == 'وضع كليشه المطور' and DevTeKo(msg) then
...
if text == 'رفع النسخه الاحتياطيه' and DevTeKo(msg) then   
if tonumber(msg.reply_to_message_id_) > 0 then
function by_reply(extra, result, success)   
...
if text == "تحديث" and DevTeKo(msg) then
dofile("TeKo.lua")  
send(msg.chat_id_, msg.id_, "• تم التحديث")
end
if text == 'السورس' or text == 'سورس' or text == 'ياسورس' or text == 'يا سورس' and GetSourseMember(msg) then       
Text = "[𝘞𝘦𝘭𝘤𝘰𝘮𝘦 𝘵𝘰 𝘕𝘪𝘨𝘨𝘢 𝘚𝘰𝘶𝘳𝘤𝘦](t.me/TeKo_SoUrcE)"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝘕𝘪𝘨𝘨𝘢 𝘚𝘰𝘶𝘳𝘤𝘦 .',url="https://t.me/TeKo_Source/117"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
if text == '@ZZZZD' or text == '@TeKo_SoUrcE' or text == 'مودي البدراني' then
Text = [[
...
tdcli_function ({ ID = "GetChannelFull", channel_id_ = msg.chat_id_:gsub("-100","")}, function(arg,data)  
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevTeKo(msg) then
...
if not DevTeKo(msg) and not database:sismember(bot_id..'BaN:In:User',msg.sender_user_id_) and not database:get(bot_id..'Texting:In:Bv') and not database:get(bot_id.."Filter"..msg.sender_user_id_) then
...
if DevTeKo(msg) and msg.reply_to_message_id_ ~= 0  then    
...
if text =='تغيير المطور الاساسي •' and TeKoDevSou(msg) then
send(msg.chat_id_, msg.id_,'• ارسل ايدي المطور الاساسي الجديد')
database:set(bot_id..'Ed:DevBots',true) 
end
if text =='تغيير المطور الاساسي •' and not TeKoDevSou(msg) then
send(msg.chat_id_, msg.id_,'• تسرسح')
end
if text == ("مسح الثانويين •") and not TeKoDevSou(msg) then
send(msg.chat_id_, msg.id_,'• تسرسح')
end
if text == ("مسح الثانويين •") and TeKoDevSou(msg) then
database:del(bot_id.."DEV:Sudo:T")
...
inline = {
{{text = '•  𝘕𝘐𝘎𝘎𝘈  .',url='http://t.me/TeKo_SoUrcE'}},
}
...
------------------------------------------------------------------------
if text then
local TeKo_Msg = database:sismember(bot_id.."List:Filter:text"..result.chat_id_,text) 
if TeKo_Msg then    
