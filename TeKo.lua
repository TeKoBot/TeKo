...
TeKo_Msg = 'قمة التفاعل🤸‍♂️😻' 
elseif msgs < 5500 then 
TeKo_Msg = 'اقوى متفاعل😳😻' 
elseif msgs < 7000 then 
TeKo_Msg = 'ملك التفاعل🤴😍' 
elseif msgs < 9500 then 
TeKo_Msg = 'امبروطور التفاعل💂‍♀️😻' 
elseif msgs < 10000000000 then 
TeKo_Msg = 'رب التفاعل✔️😍'  
end 
return TeKo_Msg 
end
...
send(msg.chat_id_, msg.id_,'📌¦ عدد المجموعات الان » { '..#group..' }'..TeKok..''..TeKo..'\n*📌┇الان عدد المجموعات الحقيقي » { '..sendok..' } مجموعات\n')   
end
end
end,nil)
end
...
usertext = '\n👤┇العضو » ['..result.title_..'](t.me/'..(username or 'TeKotaem17')..')'
...
usertext = '\n👤┇العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'TeKotaem17')..')'
status  = '\n🔘┇تم ترقيته مطور في البوت'
...
send(msg.chat_id_,0,"⚠¦العضو : {["..data.first_name_.."](T.ME/TeKotaem17)}\n📛¦["..TeKo_Msg.."] \n") 
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, "⚠┇عذرا يا » {["..data.first_name_.."](T.ME/TeKotaem17)}\n📮┇الملصق الذي ارسلته تم منعه من المجموعه \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
🔖↬TeKo TEAM
 ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
📮↬[Channel TeKo](t.me/TeKotaem17) 

🔰↬[Information](t.me/TeKotaem17)

👮‍♂️↬[DEVELOPER](t.me/BB63BB)

🔖↬[The way his inauguration](https://t.me/TeKotaem17/4)

📌↬[To talk to us](t.me/TeKoTEAMBOT)
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'👤┇بواسطه ← ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'TeKotaem17')..') \n🔘┇تـم قفـل الدردشه ')  
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'👤┇بواسطه ← ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'TeKotaem17')..') \n🔘┇تـم قفـل التاك بالكتم\n⛔┇الحاله ←الكتم ')  
end,nil)   
...
if SudoBot(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/TeKoTEAM/Files_TeKo/master/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/TeKoTEAM/Files_TeKo/master/File_Bot/"..file)
if res == 200 then
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n👤┇العضو » ['..result.title_..'](t.me/'..(text1[3] or 'TeKotaem17')..')'..'\n🔘┇تم رفعه '..text1[2]..' هنا')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
------------------------------------------------------------------------
local TeKobot = database:get(bot_id.."Add:Filter:Rp2"..text..result.chat_id_)   
if TeKobot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"⚠¦العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n📛¦["..TeKobot.."] \n") 
